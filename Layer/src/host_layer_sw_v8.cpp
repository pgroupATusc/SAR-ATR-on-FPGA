...
int main(int argc, char** argv) {
    ...
    xrt::bo boW_self = xrt::bo(device, size_t(sizeof(float) * BLOCK_NUM * BLOCK_NUM * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(3));
    xrt::bo boAX_Merge_bank1 = xrt::bo(device, size_t(sizeof(float) * BM * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boAX_Merge_bank2 = xrt::bo(device, size_t(sizeof(float) * BM * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boAX_Merge_bank3 = xrt::bo(device, size_t(sizeof(float) * BM * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
    ...
    xrt::bo boC_bank1 = xrt::bo(device, size_t(sizeof(float) * BM  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boC_bank2 = xrt::bo(device, size_t(sizeof(float) * BM  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boC_bank3 = xrt::bo(device, size_t(sizeof(float) * BM  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
    ...
    xrt::bo boW_gconv2_self = xrt::bo(device, size_t(sizeof(float) * BLOCK_NUM * BLOCK_NUM * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(3));
    xrt::bo boAX_Merge_gconv2_bank1 = xrt::bo(device, size_t(sizeof(float) * BM_gconv2 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boAX_Merge_gconv2_bank2 = xrt::bo(device, size_t(sizeof(float) * BM_gconv2 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boAX_Merge_gconv2_bank3 = xrt::bo(device, size_t(sizeof(float) * BM_gconv2 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
    ...
    xrt::bo boW_gconv2_neighbor = xrt::bo(device, size_t(sizeof(float) * (BLOCK_NUM * VDATA_SIZE  + 1)* BLOCK_NUM  * VDATA_SIZE), krnl_trans.group_id(3));
    xrt::bo boC_gconv2_bank1 = xrt::bo(device, size_t(sizeof(float) * BM_gconv2  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boC_gconv2_bank2 = xrt::bo(device, size_t(sizeof(float) * BM_gconv2  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boC_gconv2_bank3 = xrt::bo(device, size_t(sizeof(float) * BM_gconv2  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
    ...
    xrt::bo boW_gconv3_self = xrt::bo(device, size_t(sizeof(float) * BLOCK_NUM * BLOCK_NUM * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(3));
    xrt::bo boAX_Merge_gconv3_bank1 = xrt::bo(device, size_t(sizeof(float) * BM_gconv3 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boAX_Merge_gconv3_bank2 = xrt::bo(device, size_t(sizeof(float) * BM_gconv3 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boAX_Merge_gconv3_bank3 = xrt::bo(device, size_t(sizeof(float) * BM_gconv3 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
    ...
    xrt::bo boW_gconv3_neighbor = xrt::bo(device, size_t(sizeof(float) * (BLOCK_NUM * VDATA_SIZE  + 1)* BLOCK_NUM  * VDATA_SIZE), krnl_trans.group_id(3));
    xrt::bo boC_gconv3_bank1 = xrt::bo(device, size_t(sizeof(float) * BM_gconv3  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boC_gconv3_bank2 = xrt::bo(device, size_t(sizeof(float) * BM_gconv3  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boC_gconv3_bank3 = xrt::bo(device, size_t(sizeof(float) * BM_gconv3  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
    ...
    xrt::bo boW_gconv4_self = xrt::bo(device, size_t(sizeof(float) * BLOCK_NUM * BLOCK_NUM * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(3));
    xrt::bo boAX_Merge_gconv4_bank1 = xrt::bo(device, size_t(sizeof(float) * BM_gconv4 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boAX_Merge_gconv4_bank2 = xrt::bo(device, size_t(sizeof(float) * BM_gconv4 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boAX_Merge_gconv4_bank3 = xrt::bo(device, size_t(sizeof(float) * BM_gconv4 * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
    ...
    xrt::bo boW_gconv4_neighbor = xrt::bo(device, size_t(sizeof(float) * (BLOCK_NUM * VDATA_SIZE  + 1)* BLOCK_NUM  * VDATA_SIZE), krnl_trans.group_id(3));
    xrt::bo boC_gconv4_bank1 = xrt::bo(device, size_t(sizeof(float) * BM_gconv4  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(4));
    xrt::bo boC_gconv4_bank2 = xrt::bo(device, size_t(sizeof(float) * BM_gconv4  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(5));
    xrt::bo boC_gconv4_bank3 = xrt::bo(device, size_t(sizeof(float) * BM_gconv4  * VDATA_SIZE * VDATA_SIZE), krnl_trans.group_id(6));
