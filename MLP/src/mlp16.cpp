...
void loaddata(
    hls::stream<ap_axiu<256, 0, 0, 0>> & C_stream1,
    hls::stream<ap_axiu<256, 0, 0, 0>> & C_stream2,
    hls::stream<ap_axiu<256, 0, 0, 0>> & C_stream3,
...
void computeL1(
    ...
    for(int i = 0; i < 256; i++){
        for(int j = 0; j < 3; j ++){
            for(int k = 0; k < 64; k++){
                ...
                datatype stage1_p1 = tmpIn1.data[0]* tmpIn2.data[0]  + tmpIn1.data[1] * tmpIn2.data[1];
                datatype stage1_p2 = tmpIn1.data[2]* tmpIn2.data[2]  + tmpIn1.data[3] * tmpIn2.data[3];
                datatype stage1_p3 = tmpIn1.data[4]* tmpIn2.data[4]  + tmpIn1.data[5] * tmpIn2.data[5];
                datatype stage1_p4 = tmpIn1.data[6]* tmpIn2.data[6]  + tmpIn1.data[7] * tmpIn2.data[7];
                datatype stage1_p5 = tmpIn1.data[8]* tmpIn2.data[8]  + tmpIn1.data[9] * tmpIn2.data[9];
                datatype stage1_p6 = tmpIn1.data[10]*tmpIn2.data[10] + tmpIn1.data[11]*tmpIn2.data[11];
                datatype stage1_p7 = tmpIn1.data[12]*tmpIn2.data[12] + tmpIn1.data[13]*tmpIn2.data[13];
                datatype stage1_p8 = tmpIn1.data[14]*tmpIn2.data[14] + tmpIn1.data[15]*tmpIn2.data[15];

                datatype stage2_p1 = stage1_p1 + stage1_p2;
                datatype stage2_p2 = stage1_p3 + stage1_p4;
                datatype stage2_p3 = stage1_p5 + stage1_p6;
                datatype stage2_p4 = stage1_p7 + stage1_p8;

                datatype stage3_p1 = stage2_p1 + stage2_p2;
                datatype stage3_p2 = stage2_p3 + stage2_p4;

                datatype tmpresult = stage3_p1 + stage3_p2;
    ...
    for(int k = 0; k < 64; k++){
        #pragma HLS PIPELINE II=1 rewind
        #pragma HLS dependence variable=results type=inter false
        results[k] = results[k] < (datatype) 0.0?  (datatype) 0.0: results[k]; 
    }
}
