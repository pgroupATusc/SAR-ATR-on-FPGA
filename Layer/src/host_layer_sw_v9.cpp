...
int main(int argc, char** argv) {
    ...
    auto run_neigh_trans_Store1_gconv4 = store_mm1(boC_gconv4_bank1, BM_gconv4);
    auto run_neigh_trans_Store2_gconv4 = store_mm2(boC_gconv4_bank2, BM_gconv4);
    auto run_neigh_trans_Store3_gconv4 = store_mm3(boC_gconv4_bank3, BM_gconv4);

    run_neigh_trans_Load1_gconv4.wait();
    run_neigh_trans_Load2_gconv4.wait();
    run_neigh_trans_Load3_gconv4.wait();
    run_neigh_trans_Store1_gconv4.wait();
    run_neigh_trans_Store2_gconv4.wait();
    run_neigh_trans_Store3_gconv4.wait();
